                    ...
                    <table class="w-full min-w-max">
                        ...
                        <thead class="">
                            <tr class=" bg-white text-black/60 text-left">
                                ...
                                <th class="opacity-60 font-[500] pr-[24px] py-[8px]">Position</th>
                                <th class="opacity-60 font-[500] pr-[24px] py-[8px]">Email</th>
                                <th class="opacity-60 font-[500] pr-[24px] py-[8px] rounded-tr-[10px]">Contact Number
                                </th>
                                ...
                                <th class="opacity-60 font-[500] pr-[24px] py-[8px]">Platform</th>
                        ...
                        <tbody v-if="records && records.data" v-for="(record, index) in records.data">
                            ...
                            <tr class="h-[40px] bg-white text-black font-normal text-base text-left ">
                                ...
                                <td class="pr-[24px] py-[8px]">{{ record.job_title }}</td>
                                ...
                                <td class="pr-[24px] py-[8px]">{{ record.platform }}</td>
...
onMounted(() => {
    ...
    pageTitle.setTitle(`Corporate Careers`);
    pageTitle.setBreadcrumbs(['Inquiries', 'Corporate Careers']);
...
const fetchRecords = async () => {
    try {
        ...
        const records_response = await nuxtApp.$axios.get(`/cms/inquiries?inquiry_type=Corporate Careers&page=${pagination.page}
...
const exportToCSV = async () => {
    const records_response = await nuxtApp.$axios.get(`/cms/export-inquiries?inquiry_type=Corporate Careers
    &startDate=${filterValues.startDate}
    &endDate=${filterValues.endDate}`);
...
const generateExportFilename = (type) => {
    ...
    const filename = `${contentType}_Corporate-Careers_${exportType}_.${type === 'csv' ? 'csv' : 'xlsx'}`;
    return filename;
};
