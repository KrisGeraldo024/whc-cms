    ...
    <div class="overflow-y-scroll">
        <div class="p-[16px]">
            ...
            <div class="flex items-center justify-between mb-[12px]">
                <div>Displaying <b>{{ records?.length }}</b> of
                    <b>{{ totalRecords }}</b> material(s)</div>
            ...
            <table class="w-full border-separate border-spacing-y-[12px]">
                ...
                <tbody>
                    <tr
                        ...
                        <td class="py-[34.5px]">
                            <span>{{record.material_count || "pending"}}</span>
                        </td>
                        <td class="py-[34.5px]">
                            <span>
                                {{
                        ...
                        <td class="py-[34.5px] relative">
                            ...
                            <div
                                ...
                                <button v-if="record.material_count === 0"
        ...
        <PopupForm
            ...
            <Form
                ...
                <TextField
                    label="Material Name"
                    v-model="formInitialValues.materialName"
                    name="materialName"
...
onMounted(() => {
    ...
    pageTitle.setBreadcrumbs(['Taxonomies', 'Tile-Categories', 'Materials']);
    fetchRecords();
});
...
const fetchRecords = async (page = 1) => {
    try {
        const response = await nuxtApp.$axios.get(
            `/cms/taxonomies/material?page=${pagination.page}&sortBy=${sortBy.value}&sortDirection=${sortDirection.value}`
        );
        ...
        nuxtApp.$toast.error('Failed to load material');
    }
};
//  here
...
const formInitialValues = computed(() => ({
    materialName: editingRecord.value?.name || '',
}));
