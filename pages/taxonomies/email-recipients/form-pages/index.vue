        ...
        <div class="p-[16px]">
            ...
            <div class="flex items-center justify-between mb-[12px]">
                <div>
                    ...
                    {{ totalRecords }} Form Pages
                </div>

                <!-- <NuxtLink
                    to="/taxonomies/email-recipients/form-pages/create"
                    class="main-button">
                    <svg
...
onMounted(() => {
    pageTitle.reset();
    pageTitle.setTitle('Form Pages');
    pageTitle.setBreadcrumbs(['Taxonomies', 'Email Recipients', 'Form Pages']);
