...
onMounted(() => {
    ...
    pageTitle.setTitle(`Add Client`);
    pageTitle.setBreadcrumbs(['Client', 'Client List', 'Add Client']);

    pageTitle.setPageFrom('Client List');
    ...
    const submit = async () => {
        ...
        try {
            const response = await nuxtApp.$axios.post(`/cms/clients`, form_data , {
                headers: {
                ...
                nuxtApp.$toast.success('Client created successfully!');
