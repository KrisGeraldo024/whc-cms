        ...
        <Form v-if="awardData" id="form" @submit="submit()" class="w-full gap-[16px] flex flex-col">
            <div class="bg-white p-[16px] flex flex-col gap-[16px] rounded-[10px] w-full">
                ...
                <div class="grid grid-cols-1 gap-[16px]">
                    <TextField label="Award Name" name="name" v-model="formData.name" placeholder="e.g. Award ABC"
                ...
                <div class="grid grid-cols-1 gap-[16px]">
                    <TextField class="col-span-3" label="Awarding Body" name="awarding_body"
                        v-model="formData.awarding_body" placeholder="e.g. Awarding Body ABC"
                        :rules="'required|max:100'" optionalMessage="Max 100 characters" />
                ...
                <ImageHandler label="Award Image" max="1" size="5" :dimension="{ width: 125, height: 90 }"
                    :data="main_image" :input_payload="{
