    ...
    <div class="overflow-y-scroll">
        <div class="p-[16px]">
            ...
            <div class="flex items-center justify-between mb-[12px]">
                <div>
                    Displaying {{ records.length }} of {{ totalRecords }} Online
                    Payment Platforms
                </div>
                <!-- this -->
                <NuxtLink
                    class="main-button"
                    :to="`/payment-channels/payment-methods/${route.params.methodId}/payment-platforms/create`">
                    <svg
                    ...
                    <tr
                        ...
                        <td class="py-[34.5px] relative">
                            ...
                            <div
                                ...
                                <NuxtLink
                                    :to="`/payment-channels/payment-methods/${route.params.methodId}/payment-platforms/${record.id}/edit`"
                                ...
                                <button
                                    ...
                                    @click="
                                        openDeletePopup(
                                            `/cms/payment-methods/${route.params.methodId}/payment-platforms/${record.id}`
                                        )
                                    ">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
...
onMounted(() => {
    ...
    pageTitle.reset();
    pageTitle.setTitle('Payment Platforms');
